      ...
      datasets: [
        {
          ...
          data: [this.prContributor, this.issuesContributor, this.commitsContributor],
          label: "Contributor"
        },
        {
          backgroundColor: "#FF6B6B",
          data: [this.prOrganization, this.issuesOrganization, this.commitsOrganization],
          label: "Organization"
        }
      ],
      options: {
